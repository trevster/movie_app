...
class NowPlayingModel {
  ...
  int? _totalPages;
  int? _totalResults;
NowPlayingModel copyWith({  int? page,
  List<Results>? results,
  Dates? dates,
  int? totalPages,
  int? totalResults,
}) => NowPlayingModel(  page: page ?? _page,
...
class Results {
  ...
  Results.fromJson(dynamic json) {
    ...
    _video = json['video'];
    _voteAverage = double.tryParse('${json['vote_average']}');
  }
  String? _posterPath;
  bool? _adult;
  String? _overview;
  ...
  bool? _video;
  double? _voteAverage;
Results copyWith({  String? posterPath,
  bool? adult,
  String? overview,
  String? releaseDate,
  List<int>? genreIds,
